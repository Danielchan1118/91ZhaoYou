...
class AdminController extends Controller {
	...
	public function CheckUsers(){
		...
		if(!in_array(ACTION_NAME, $noUserAct)){
			$this->redirect('Admin/Index/UserLogin@s.91zhaoyou.com');
		}
	}
	...
	public function haveRole(){ 
		...
		$r = M('role');
		$access_id = $r->table('sw_role r')->where("r.display=0 AND r.id=".$roleid)
				->join("LEFT JOIN sw_role_access ra ON ra.role_id=r.id")->getField('ra.access_id');
