...
class AdminLoginController extends AdminController {
	...
	public function ListAdmin($eid = ''){
		...
		$this->admin_list = $M->table('sw_role as a')->join('sw_admin_login as u on a.id = u.role_id')->field('a.role_name,u.username,u.display,u.login_ip,u.login_time,u.id')->limit($Page->firstRow.','.$Page->listRows)->select();
		$this->Page  = $Page->show(); 
