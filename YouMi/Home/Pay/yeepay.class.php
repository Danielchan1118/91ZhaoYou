...
class yeepay {
	...
	public function BeginPay($arr) {
		...
		require_once $dir . '/YouMi/Home/Pay/yeepay/yeepayCommon.php';
		...
		$data ['p8_Url'] = 'http://' . $_SERVER ['HTTP_HOST']."/Home/PayReturn/yeePayAdmin";
	...
	public function CallBack($get = array(), $pay = array()) {
		...
		require $dir . '/Lib/Pay/yeepay/yeepayCommon.php';
